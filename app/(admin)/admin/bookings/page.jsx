...
export default function AdminBookingsPage() {
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute("download", `Data_Pesanan_NekoStay_${activeTab}.csv`);
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-center gap-4 flex-wrap">
        <div className="space-y-1">
          <div className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-rose-500/10 text-rose-600 text-[10px] font-extrabold uppercase tracking-wider">
            ...
            <span>Pemberitahuan & Persetujuan</span>
          </div>
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-foreground">
            Semua Pesanan Penitipan
          </h1>
          <p className="text-sm text-muted-foreground">
            Konfirmasi pengajuan check-in, setujui penolakan, serta lakukan
            kalkulasi tagihan check-out.
          </p>
        </div>
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            <span className="hidden sm:inline text-xs font-bold">Ekspor CSV</span>
          </button>
          <button
      ...
      {/* Search & Class Filter */}
      <div className="flex flex-col sm:flex-row gap-4 justify-between items-center bg-card border border-border p-4 rounded-2xl">
        <div className="relative w-full sm:max-w-xs">
          <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
          <input
            type="text"
            placeholder="Cari kucing atau pemilik..."
            value={searchQuery}
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto shrink-0">
          <span className="text-xs font-semibold text-muted-foreground whitespace-nowrap">Kelas Room:</span>
          <select
            value={selectedClass}
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16 bg-card border border-border border-dashed rounded-3xl p-8 max-w-xl mx-auto text-muted-foreground">
          ...
          <p className="text-sm font-bold">Tidak ada pesanan.</p>
          <p className="text-xs">
            Belum ada pemesanan dalam status filter &quot;{activeTab}&quot;.
          </p>
        </div>
      ) : (
            ...
            <table className="w-full text-left text-sm border-collapse">
              <thead>
                <tr className="bg-muted/40 border-b border-border/80 text-muted-foreground font-bold">
                  ...
                  <th className="p-4 sm:p-5">Pemilik & Kucing</th>
                  <th className="p-4 sm:p-5">Kelas & Tarif</th>
                  <th className="p-4 sm:p-5">Durasi Jadwal</th>
                  <th className="p-4 sm:p-5">Estimasi Biaya</th>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg bg-card border border-border p-6 sm:p-8 rounded-3xl shadow-xl space-y-6 animate-in fade-in zoom-in duration-200">
            ...
            <div className="space-y-4 text-xs sm:text-sm">
              ...
              <div className="p-3 bg-secondary text-secondary-foreground text-xs rounded-xl leading-relaxed font-semibold">
                📝 Info: {checkoutCalc.notes}
              </div>
            </div>
