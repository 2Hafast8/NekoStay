...
export const ERROR_RULES = [
  ...
  {
    pattern: /captcha.*(?:disallowed|no captcha_token|failed|invalid|missing)/i,
  ...
  {
    pattern: /invalid (?:login )?credentials|invalid_grant|invalid_credentials/i,
...
export function formatUserError(err, options = {}) {
  ...
  // 1. Cek terhadap aturan terdaftar
