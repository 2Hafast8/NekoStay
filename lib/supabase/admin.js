...
export async function verifyBookingAccess(supabase, bookingId) {
  try {
    ...
    if (!user) {
      return { isAllowed: false, hasAccess: false, isOwner: false, isAdmin: false, user: null, booking: null };
    }
    ...
    if (error || !booking) {
      return { isAllowed: false, hasAccess: false, isOwner: false, isAdmin, user, booking: null };
    }
