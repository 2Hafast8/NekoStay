...
13. [AI Agent Skills Registry (.agent/skills)](#13-ai-agent-skills-registry-agentskills)
...
### Panduan Penggunaan Skill di NekoStay

#### 1. Keamanan Endpoint API & Database (Supabase + Next.js)
Gunakan kombinasi skill `backend-security-coder` dan `security-auditor`:
